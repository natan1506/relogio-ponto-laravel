                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="filial" type="text" class="form-control @error('filial') is-invalid @enderror" name="filial" onkeyup="this.value = this.value.toUpperCase();" value="{{ old('filial') }}" required autocomplete="filial" autofocus>
